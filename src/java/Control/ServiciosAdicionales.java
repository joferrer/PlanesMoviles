 ...
 * @author jeiso
 */
public class ServiciosAdicionales extends HttpServlet {
...
//            out.println("<html>");
//            out.println("<head>");
//            out.println("<title>Servlet ServiciosAdicionales</title>");            
//            out.println("</head>");
//            out.println("<body>");
//            out.println("<h1>Servlet ServiciosAdicionales at " + request.getContextPath() + "</h1>");
//            out.println("</body>");
//            out.println("</html>");
//        }
          ...
          if(!lista.isEmpty()){
              ...
              request.getSession().setAttribute("servicios", lista);
